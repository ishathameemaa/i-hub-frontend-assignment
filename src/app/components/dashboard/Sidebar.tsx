...
export default function Sidebar() {
  ...
  const { data: navigationItems, isLoading } = useNavigation(role);
  ...
  return (
    <>
      ...
      <div
        ...
        } md:translate-x-0 fixed md:static top-0 left-0 h-screen w-64 bg-gray-800 transform transition-transform duration-200 ease-in-out z-40`}
      >
